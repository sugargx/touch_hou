  ...
  return function(e) {
    ...
    e.exports = function(e) {
          ...
          m = {
            ...
            getAuth: function(e) {
              ...
              var u = function(e) {
                ...
                g = t,
                m = f + ";" + (h += void 0 === p ? 900 : 1 * p || 0),
                y = f + ";" + h,
                v = u(c).join(";").toLowerCase(),
                C = u(s).join(";").toLowerCase(),
                x = l.HmacSHA1(y, n).toString(),
                A = [i, a, d(s), d(c), ""].join("\n"),
                b = ["sha1", m, l.SHA1(A).toString(), ""].join("\n");
              return ["q-sign-algorithm=sha1", "q-ak=" + g, "q-sign-time=" + m, "q-key-time=" + y, "q-header-list=" + v, "q-url-param-list=" + C, "q-signature=" + l.HmacSHA1(b, x).toString()].join("&")
            },
            xml2json: d,
            json2xml: f,
            md5: u,
      ...
      function o(e, t) {
        ...
        else n = this, Error.call(this, J[e]), this.message = J[e], Error.captureStackTrace && Error.captureStackTrace(this, o);
          ...
          case U:
            ...
            if (s || n && !/^(?:meta|link|img|br|hr|input)$/i.test(c)) {
              if (t.push(">"), n && /^script$/i.test(c))
                for (; s;) s.data ? t.push(s.data) : P(s, t, n, r, o), s = s.nextSibling;
              else
                for (; s;) P(s, t, n, r, o), s = s.nextSibling;
              t.push("</", c, ">")
            } else t.push("/>");
            return;
          case W:
          case Q:
            for (s = e.firstChild; s;) P(s, t, n, r, o), s = s.nextSibling;
            return;
          case H:
      ...
      var j = "http://www.w3.org/1999/xhtml",
        L = {},
        U = L.ELEMENT_NODE = 1,
        H = L.ATTRIBUTE_NODE = 2,
        K = L.TEXT_NODE = 3,
        G = L.CDATA_SECTION_NODE = 4,
        V = L.ENTITY_REFERENCE_NODE = 5,
        q = L.ENTITY_NODE = 6,
        z = L.PROCESSING_INSTRUCTION_NODE = 7,
        X = L.COMMENT_NODE = 8,
        W = L.DOCUMENT_NODE = 9,
        $ = L.DOCUMENT_TYPE_NODE = 10,
        Q = L.DOCUMENT_FRAGMENT_NODE = 11,
        Z = L.NOTATION_NODE = 12,
        Y = {},
        J = {},
      ...
      Y.INVALID_STATE_ERR = (J[11] = "Invalid state", 11), Y.SYNTAX_ERR = (J[12] = "Syntax error", 12), Y.INVALID_MODIFICATION_ERR = (J[13] = "Invalid modification", 13), Y.NAMESPACE_ERR = (J[14] = "Invalid namespace", 14), Y.INVALID_ACCESS_ERR = (J[15] = "Invalid access", 15), o.prototype = Error.prototype, n(Y, o), i.prototype = {
        ...
        cloneNode: function(e) {
          return function e(t, n, r) {
            ...
            if (r)
              for (var h = n.firstChild; h;) o.appendChild(e(t, h, r)), h = h.nextSibling;
            return o
      ...
      }, n(L, h), n(L, h.prototype), m.prototype = {
        nodeName: "#document",
        nodeType: W,
        doctype: null,
        ...
        insertBefore: function(e, t) {
          ...
          return null == this.documentElement && e.nodeType == U && (this.documentElement = e), x(this, e, t), e.ownerDocument = this, e
        },
        removeChild: function(e) {
        ...
        getElementsByTagNameNS: function(e, t) {
          return new a(this, function(n) {
            ...
            return g(n, function(o) {
              o === n || o.nodeType !== U || "*" !== e && o.namespaceURI !== e || "*" !== t && o.localName != t || r.push(o)
            }), r
          })
        }
      }, m.prototype.getElementsByTagName = A.prototype.getElementsByTagName, m.prototype.getElementsByTagNameNS = A.prototype.getElementsByTagNameNS, r(A, h), b.prototype.nodeType = H, r(b, h), w.prototype = {
        data: "",
        ...
        nodeType: G
      }, r(S, w), R.prototype.nodeType = $, r(R, h), _.prototype.nodeType = Z, r(_, h), E.prototype.nodeType = q, r(E, h), k.prototype.nodeType = V, r(k, h), D.prototype.nodeName = "#document-fragment", D.prototype.nodeType = Q, r(D, h), B.prototype.nodeType = z, r(B, h), O.prototype.serializeToString = function(e, t, n) {
        return I.call(e, t, n)
      }, h.prototype.toString = I;
      try {
      ...
      e.exports = function(e, t) {
        ...
        if (r) {
          ...
          for (var l in e.headers) e.headers.hasOwnProperty(l) && (l.indexOf("x-cos-meta-") > -1 || f.indexOf(l) > -1) && (d[l] = e.headers[l]);
          o["x-cos-acl"] && (d.acl = o["x-cos-acl"]), !d["Content-Type"] && (d["Content-Type"] = ""), (n = wx.uploadFile({
            url: i,
            method: a,
            name: "file",
            filePath: r,
          ...
          var h = e.qs && function(e) {
            var t, n, r, o = [],
              i = Object.keys(e);
            for (t = 0; t < i.length; t++) r = e[n = i[t]] || "", o.push(n + "=" + encodeURIComponent(r));
            return o.join("&")
          }(e.qs) || "";
          h && (i += (i.indexOf("?") > -1 ? "&" : "?") + h), o["Content-Length"] && delete o["Content-Length"], wx.request({
            url: i,
            method: a,
            header: o,
            dataType: "text",
      ...
      e.exports = function(e) {
        if (!e) return null;
        var t = (new r).parseFromString(e, "text/xml"),
          n = (new function(e) {
            "use strict";
            ...
            function v(e, t, n, r) {
              var o = "";
              if (0 == e.length) o += l(e, t, n, !0);
              else
                for (var i = 0; i < e.length; i++) o += l(e[i], t, g(e[i]), !1), o += C(e[i], y(r, t)), o += d(e[i], t);
              return o
            }
      ...
      r.prototype.parseFromString = function(e, t) {
        ...
        startElement: function(e, t, n, r) {
          ...
          for (var c = 0; c < s; c++) {
            e = r.getURI(c);
            var l = r.getValue(c),
              d = (n = r.getQName(c), o.createAttributeNS(e, n));
      ...
      function r(e, t, n, r, u) {
        ...
        function p(t) {
          if (t > b) {
            var n = e.substring(b, t).replace(/&#?\w+;/g, h);
            C && g(b), r.characters(n, 0, t - b), b = t
          }
        }
          ...
          try {
            ...
            if (w < 0) {
              if (!e.substr(b).match(/^\s*$/)) {
                var T = r.doc,
                  N = T.createTextNode(e.substr(b));
                T.appendChild(N), r.currentElement = N
              }
              return
            }
            switch (w > b && p(w), e.charAt(w + 1)) {
              case "/":
                var S = e.indexOf(">", w + 3),
                  R = e.substring(w + 2, S),
                  _ = x.pop();
                S < 0 ? (R = e.substring(w + 2).replace(/[\s<].*/, ""), u.error("end tag name: " + R + " is not complete:" + _.tagName), S = w + 1 + R.length) : R.match(/\s</) && (R = R.replace(/[\s<].*/, ""), u.error("end tag name: " + R + " maybe not complete"), S = w + 1 + R.length);
                var E = _.localNSMap,
                  k = _.tagName == R;
                if (k || _.tagName && _.tagName.toLowerCase() == R.toLowerCase()) {
                  if (r.endElement(_.uri, _.localName, R), E)
                    for (var D in E) r.endPrefixMapping(D);
                  k || u.fatalError("end tag name: " + R + " is not match the current start tagName:" + _.tagName)
                } else x.push(_);
                S++;
                break;
              case "?":
              ...
              default:
                C && g(w);
                var B = new f,
                  O = x[x.length - 1].currentNSMap,
                  I = (S = i(e, w, B, O, h, u), B.length);
                if (!B.closed && c(e, S, B.tagName, A) && (B.closed = !0, n.nbsp || u.warning("unclosed xml attribute")), C && I) {
                  for (var M = o(C, {}), P = 0; P < I; P++) {
                    var F = B[P];
                    g(F.offset), F.locator = o(C, {})
                  }
                  r.locator = M, a(B, r, O) && x.push(B), r.locator = C
                } else a(B, r, O) && x.push(B);
                "http://www.w3.org/1999/xhtml" !== B.uri || B.closed ? S++ : S = s(e, S, B.tagName, h, r)
            }
          } catch (e) {
            u.error("element parse error: " + e), S = -1
          }
          S > b ? b = S : p(Math.max(w, b) + 1)
        }
      }
          ...
          switch (u) {
            ...
            case '"':
              if (c === x || c === v) {
                ...
                l = e.slice(t, s).replace(/&#?\w+;/g, o), n.add(a, l, t - 1), c = b
              } else {
                if (c != A) throw new Error('attribute value must after "="');
                l = e.slice(t, s).replace(/&#?\w+;/g, o), n.add(a, l, t), i.warning('attribute "' + a + '" missed start quot(' + u + ")!!"), t = s + 1, c = b
              }
              break;
            case "/":
              switch (c) {
            ...
            case ">":
              switch (c) {
                ...
                case C:
                  c === C && (l = a), c == A ? (i.warning('attribute "' + l + '" missed quot(")!!'), n.add(a, l.replace(/&#?\w+;/g, o), t)) : ("http://www.w3.org/1999/xhtml" === r[""] && l.match(/^(?:disabled|checked|selected)$/i) || i.warning('attribute "' + l + '" missed value!! "' + l + '" instead!!'), n.add(l, l, t));
                  break;
                case x:
      ...
      function a(e, t, n) {
        for (var r = e.tagName, o = null, i = e.length; i--;) {
          var a = e[i],
            s = a.qName,
            c = a.value;
          if ((h = s.indexOf(":")) > 0) var l = a.prefix = s.slice(0, h),
            d = s.slice(h + 1),
            f = "xmlns" === l && d;
      ...
      var p = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
        ...
        m = new RegExp("^" + p.source + g.source + "*(?::" + p.source + g.source + "*)?$"),
        y = 0,
        v = 1,
        C = 2,
        x = 3,
      ...
      function s(e, t) {
        ...
        e.action && (r[e.action] = ""), a.call(n, {
          ...
          if (o)
            if (o.indexOf(" ") > -1) a = !1;
            else if (o.indexOf("q-sign-algorithm=") > -1 && o.indexOf("q-ak=") > -1 && o.indexOf("q-sign-time=") > -1 && o.indexOf("q-key-time=") > -1 && o.indexOf("q-url-param-list=") > -1) a = !0;
          else try {
        ...
        l = {
          ...
          putBucketAcl: function(e, t) {
            ...
            if (e.AccessControlPolicy) {
              var i = u.clone(e.AccessControlPolicy || {}),
                a = i.Grants || i.Grant;
              a = u.isArray(a) ? a : [a], delete i.Grant, delete i.Grants, i.AccessControlList = {
                Grant: a
              }, r = u.json2xml({
                AccessControlPolicy: i
              }), n["Content-Type"] = "application/xml", n["Content-MD5"] = u.binaryBase64(u.md5(r))
            }
          ...
          getBucketTagging: function(e, t) {
            s.call(this, {
              ...
              if (e)
                ...
                o = u.clone(u.isArray(o) ? o : [o]), t(null, {
                  Tags: o,
                  statusCode: n.statusCode,
                  headers: n.headers
                })
          ...
          getObject: function(e, t) {
            ...
            r["response-content-type"] = e.ResponseContentType, r["response-content-language"] = e.ResponseContentLanguage, r["response-expires"] = e.ResponseExpires, r["response-cache-control"] = e.ResponseCacheControl, r["response-content-disposition"] = e.ResponseContentDisposition, r["response-content-encoding"] = e.ResponseContentEncoding, n = u.isBrowser ? "string" : "buffer", s.call(this, {
              ...
              var a = {};
              "string" === n && (a.Body = o.body), u.extend(a, {
                statusCode: o.statusCode,
                headers: o.headers
              }), t(null, a)
            })
          ...
          postObject: function(e, t) {
            ...
            var o = e.FilePath;
            for (var a in e) a.indexOf("x-cos-meta-") > -1 && (r[a] = e[a]);
